...
`pageWidth`: The page width of the blank page to insert. Unit: inch. Value range: [1/96, 100].

`pageHeight`: The page height of the blank page to insert. Unit: inch. Value range: [1/96, 100].
